...
// UPGRADED: Includes Live Preview HTML Generator
// ============================================
...
class TemplateEngine {
  ...
  // ============================================
  // MOCK DATA GENERATORS (For Visual Variance)
  // ============================================
  private getMockData(templateCategory: string = 'professional') {
    // Executive / Corporate Style
    if (templateCategory === 'executive') {
      return {
        contact: { fullName: 'Sarah K. Henderson', email: 's.henderson@exec.com', phone: '+1 415 555 0199', location: 'San Francisco, CA' },
        summary: 'C-suite Operations Executive with 15+ years driving global digital transformation. Expert in scaling SaaS companies from $50M to $500M ARR.',
        experience: [
          { position: 'Chief Operating Officer', company: 'CloudCore Solutions Inc.', date: '2018–Present', ach: ['Scaled ARR from $120M to $520M.', 'Reduced overhead by 18% via AI automation.'] },
          { position: 'VP of Product Ops', company: 'FinTech Global Ltd.', date: '2014–2018', ach: ['Launched 3 products generating $45M in first year.', 'Grew EMEA team from 50 to 250.'] }
        ],
        education: [{ degree: 'MBA, Strategy', school: 'Harvard Business School', year: '2012' }],
        skills: ['Strategic Planning', 'M&A Integration', 'Executive Leadership', 'P&L Management'],
      };
    } 
    // Creative / Modern Style
    else if (templateCategory === 'creative') {
      return {
        contact: { fullName: 'Elena M. Ricci', email: 'elena@creativestudio.co', phone: '+39 328 123 4567', location: 'Milan, Italy' },
        summary: 'Multi-disciplinary Product Designer with 8+ years blending minimalist aesthetics with high-conversion UX. A\'Design Award Winner 2023.',
        experience: [
        ...
        education: [{ degree: 'MFA Interaction Design', school: 'Politecnico di Milano', year: '2016' }],
        skills: ['Figma', 'Adobe Suite', 'Webflow', 'Design Systems', 'User Research'],
      };
    } 
    // Technical / Data Science / Default (Mwanza, Minimal, etc.)
    else {
      return {
        contact: { fullName: 'Dr. Alexander Mwangi', email: 'alex.mwangi@email.com', phone: '+254 712 345 678', location: 'Nairobi, Kenya' },
        summary: 'Award-winning Data Science Leader with 10+ years driving AI innovation across fintech, telco, and healthcare sectors. PhD in ML from Carnegie Mellon.',
        experience: [
          { position: 'Director of Data Science', company: 'Safaricom PLC', date: '2022–Present', ach: ['Architected 15+ production ML models, $12.4M annual revenue.', 'Led FraudShield AI: 10,000+ TPS, 99.7% accuracy.'] },
          { position: 'Senior Research Scientist', company: 'Google DeepMind', date: '2019–2021', ach: ['Developed novel GNN architecture for protein folding.', 'Published 8 papers at NeurIPS with 1,200+ citations.'] }
        ],
        education: [{ degree: 'PhD Machine Learning', school: 'Carnegie Mellon University', year: '2020' }],
        skills: ['Python', 'TensorFlow', 'PyTorch', 'Kubernetes', 'AWS'],
      };
    }
  }

  // ============================================
  // NEW: THE ENGINE GENERATES THE PREVIEW HTML
  // ============================================
  generatePreviewHTML(templateId: string, scale: number = 1): string {
    ...
    return `
      <div style="font-family: ${fonts.body}; background: ${colors.background}; color: ${colors.text}; height: 100%; width: 100%; padding: ${8 * scale}px; box-sizing: border-box; overflow: hidden; display: flex; flex-direction: column; border-radius: 2px;">
        ...
        <!-- Summary -->
        <div style="font-size: ${9 * scale}px; line-height: 1.4; margin-bottom: ${8 * scale}px; color: ${colors.text}; padding: 0 ${4 * scale}px;">
          ${s.summary}
        </div>
        ...
        <!-- Education & Skills Flex Row -->
        <div style="display: flex; gap: ${8 * scale}px; margin-top: auto; padding: ${6 * scale}px ${4 * scale}px; border-top: 2px solid ${colors.borderColor};">
          <div style="flex: 1;">
            ...
            ${s.education.map((edu: any) => `
              <div style="font-size: ${8 * scale}px; line-height: 1.3; color: #374151;">
          ...
          <div style="flex: 1;">
            ...
            <div style="display: flex; flex-wrap: wrap; gap: ${3 * scale}px;">
  ...
  private initializeTemplates(): void {
    const templates: TemplateConfig[] = [
      ...
      // ============================================
      {
        ...
        sections: [
          { id: 'contact', title: 'Contact Information', enabled: true, order: 0, required: true, alignment: 'left', icon: '📧' },
          { id: 'summary', title: 'Professional Summary', enabled: true, order: 1, required: true, alignment: 'left', icon: '📄' },
          { id: 'skills', title: 'Core Competencies', enabled: true, order: 2, required: false, alignment: 'left', icon: '💡', maxItems: 15 },
          { id: 'experience', title: 'Professional Experience', enabled: true, order: 3, required: true, alignment: 'left', icon: '💼' },
          { id: 'projects', title: 'Key Projects', enabled: true, order: 4, required: false, alignment: 'left', icon: '🚀' },
          { id: 'education', title: 'Education & Credentials', enabled: true, order: 5, required: true, alignment: 'left', icon: '🎓' },
          { id: 'skills', title: 'Technical Profile & Tools', enabled: true, order: 6, required: false, alignment: 'left', icon: '🛠️' },
          { id: 'certifications', title: 'Certifications', enabled: true, order: 7, required: false, alignment: 'left', icon: '📜' },
          { id: 'languages', title: 'Languages', enabled: true, order: 8, required: false, alignment: 'left', icon: '🌐' },
        ],
        atsCompatibility: 98,
        popularity: 100,
        isPremium: false,
      ...
      // ============================================
      {
        ...
        colors: {
          primary: '#2563EB', secondary: '#1E40AF', accent: '#3B82F6', text: '#1F2937', background: '#FFFFFF', headingText: '#111827', borderColor: '#E5E7EB', linkColor: '#2563EB', bulletColor: '#2563EB', dividerColor: '#E5E7EB', highlightColor: '#EFF6FF', successColor: '#10B981', errorColor: '#EF4444', warningColor: '#F59E0B',
        },
        fonts: {
          heading: 'Inter, sans-serif', body: 'Inter, sans-serif', accent: 'Inter, sans-serif',
          sizes: { name: '28px', headings: '14px', body: '11px', small: '9px', xSmall: '8px', large: '16px' },
          lineHeight: { body: 1.5, heading: 1.2 },
          letterSpacing: { heading: '0.5px', body: '0.2px' },
        },
        ...
        features: [{ icon: '🎯', label: 'ATS Optimized', description: 'Designed for ATS compatibility' }, { icon: '🎨', label: 'Custom Colors', description: 'Accent color customization' }, { icon: '📱', label: 'Responsive', description: 'Works on all devices' }],
      },
      // ============================================
      // 3. EXECUTIVE CLASSIC
      // ============================================
      {
        ...
        colors: {
          primary: '#1F2937', secondary: '#374151', accent: '#6B7280', text: '#111827', background: '#FFFFFF', headingText: '#000000', borderColor: '#D1D5DB', linkColor: '#1F2937', bulletColor: '#374151', dividerColor: '#D1D5DB', highlightColor: '#F9FAFB', successColor: '#10B981', errorColor: '#EF4444', warningColor: '#F59E0B',
        },
        fonts: {
          heading: 'Georgia, serif', body: 'Georgia, serif', accent: 'Arial, sans-serif',
          sizes: { name: '24px', headings: '13px', body: '10.5px', small: '9px', xSmall: '8px', large: '15px' },
          lineHeight: { body: 1.4, heading: 1.3 },
          letterSpacing: { heading: '0.3px', body: '0.1px' },
        },
        ...
        features: [{ icon: '🏛️', label: 'Executive Style', description: 'Traditional executive layout' }, { icon: '📄', label: 'Page Friendly', description: 'Optimized for printing' }],
      },
      // ============================================
      // 4. CREATIVE TECH
      // ============================================
      {
        ...
        colors: {
          primary: '#7C3AED', secondary: '#6D28D9', accent: '#8B5CF6', text: '#374151', background: '#FAFAFA', headingText: '#1F2937', borderColor: '#E5E7EB', linkColor: '#7C3AED', bulletColor: '#7C3AED', dividerColor: '#E5E7EB', highlightColor: '#EDE9FE', successColor: '#10B981', errorColor: '#EF4444', warningColor: '#F59E0B',
        },
        fonts: {
          heading: 'Poppins, sans-serif', body: 'Inter, sans-serif', accent: 'Poppins, sans-serif',
          sizes: { name: '28px', headings: '15px', body: '10px', small: '8px', xSmall: '7px', large: '17px' },
          lineHeight: { body: 1.6, heading: 1.3 },
          letterSpacing: { heading: '0.4px', body: '0.2px' },
        },
        ...
        features: [{ icon: '🎨', label: 'Creative Design', description: 'Unique creative layout' }, { icon: '💻', label: 'Tech Focus', description: 'Optimized for tech roles' }, { icon: '🌟', label: 'Premium', description: 'Premium template features' }],
      },
      // ============================================
      // 5. MINIMAL ACADEMIC
      // ============================================
      {
        ...
        colors: {
          primary: '#059669', secondary: '#047857', accent: '#10B981', text: '#334155', background: '#FFFFFF', headingText: '#0F172A', borderColor: '#CBD5E1', linkColor: '#059669', bulletColor: '#047857', dividerColor: '#CBD5E1', highlightColor: '#ECFDF5', successColor: '#10B981', errorColor: '#EF4444', warningColor: '#F59E0B',
        },
        fonts: {
          heading: 'Helvetica, Arial, sans-serif', body: 'Helvetica, Arial, sans-serif', accent: 'Helvetica, Arial, sans-serif',
          sizes: { name: '22px', headings: '12px', body: '10px', small: '9px', xSmall: '8px', large: '14px' },
          lineHeight: { body: 1.4, heading: 1.2 },
          letterSpacing: { heading: '0.3px', body: '0.1px' },
        },
        ...
        features: [{ icon: '📚', label: 'Academic Focus', description: 'Optimized for academic CVs' }, { icon: '📄', label: 'Publication Ready', description: 'Includes publications section' }],
      },
      // ============================================
      // 6. CORPORATE FINANCE
      // ============================================
      {
        ...
        colors: {
          primary: '#0F766E', secondary: '#115E59', accent: '#14B8A6', text: '#1E293B', background: '#FFFFFF', headingText: '#0F172A', borderColor: '#CBD5E1', linkColor: '#0F766E', bulletColor: '#115E59', dividerColor: '#CBD5E1', highlightColor: '#CCFBF1', successColor: '#10B981', errorColor: '#EF4444', warningColor: '#F59E0B',
        },
        fonts: {
          heading: 'Arial, sans-serif', body: 'Arial, sans-serif', accent: 'Arial, sans-serif',
          sizes: { name: '24px', headings: '13px', body: '10.5px', small: '9px', xSmall: '8px', large: '15px' },
          lineHeight: { body: 1.4, heading: 1.2 },
          letterSpacing: { heading: '0.2px', body: '0.1px' },
        },
        ...
        features: [{ icon: '🏢', label: 'Corporate Style', description: 'Professional corporate layout' }, { icon: '📊', label: 'Finance Focus', description: 'Optimized for finance roles' }, { icon: '🌟', label: 'Premium', description: 'Premium template features' }],
      },
    ];
